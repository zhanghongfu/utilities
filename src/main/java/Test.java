...
public class Test {
    ...
    public static void main2(String[] args) {
        ...
        String[] strings = IP.find("245.141.139.0");//返回字符串数组["GOOGLE","GOOGLE"]
        for (String s : strings)
            System.out.println(s);
    }

    public static void main(String[] args) throws IOException {
        List<String> ipDataList = FileUtils.readLines(new File("/Users/admaster/ip.txt"));
        ...
        FileUtils.writeStringToFile(new File("/Users/admaster/ip1.txt"),sb.toString(),"utf-8");
    }

    public static void main1(String[] args) throws IOException {
        List<String> ipDataList = FileUtils.readLines(new File(Test.class.getResource("/").getPath() + "ipData.txt"));
        ...
        List<String> ipRegionList = FileUtils.readLines(new File(Test.class.getResource("/").getPath() + "ipRegion.txt"));
        StringBuffer sb = new StringBuffer();
...
//            }
        ...
        FileUtils.writeStringToFile(new File("/Users/admaster/ip.txt"), sb.toString(), "utf-8");
        System.out.println("------");
    }
}
